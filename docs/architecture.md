...
<!-- bespoke diagram: edit diagrams/hub-and-spoke.mmd or .hints.json, then: npx pict-renderer-graph build modules/meadow/meadow-connection-manager/docs -->
![Hub and Spoke](diagrams/hub-and-spoke.svg)
...
<!-- bespoke diagram: edit diagrams/connection-lifecycle.mmd or .hints.json, then: npx pict-renderer-graph build modules/meadow/meadow-connection-manager/docs -->
...
<!-- bespoke diagram: edit diagrams/graceful-fallback-for-optional-drivers.mmd or .hints.json, then: npx pict-renderer-graph build modules/meadow/meadow-connection-manager/docs -->
![Graceful Fallback for Optional Drivers](diagrams/graceful-fallback-for-optional-drivers.svg)
...
<!-- bespoke diagram: edit diagrams/form-schema-discovery.mmd or .hints.json, then: npx pict-renderer-graph build modules/meadow/meadow-connection-manager/docs -->
![Form-Schema Discovery](diagrams/form-schema-discovery.svg)
...
<!-- bespoke diagram: edit diagrams/where-the-manager-fits-in-retold.mmd or .hints.json, then: npx pict-renderer-graph build modules/meadow/meadow-connection-manager/docs -->
![Where the Manager Fits in Retold](diagrams/where-the-manager-fits-in-retold.svg)
